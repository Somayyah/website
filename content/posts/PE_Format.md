...
I created a simple c++ executable to compare against, does nothing:
...
and it's 11 KBs in size, what if I add a 4096 bytes of data?
...
Size difference ~= 9,216

```
➜ ls -al ConsoleApplication1.exe  ## Before additional data
-rwxrwxrwx 1 watari watari 10752 Jun 23 20:17 ConsoleApplication1.exe
➜ ls -al ConsoleApplication1.exe ## After additional data
-rwxrwxrwx 1 watari watari 19968 Jun 23 20:15 ConsoleApplication1.exe
```

Let's find the SizeOfCode and SizeOfInitializedData, the signature + COFF header content for our test file:

```
➜ xxd -s 0xf0 -l 24 ConsoleApplication1.exe
000000f0: 5045 0000 6486 0600 148c 5968 0000 0000  PE..d.....Yh....
00000100: 0000 0000 f000 2200                      ......".
```

Followed by the optional header:

```
### First section

➜ xxd -s 0x108 -l 24 ConsoleApplication1.exe
00000108: 0b02 0e2c 000e 0000 001e 0000 0000 0000  ...,............
00000118: a012 0000 0010 0000                      ........

### Second section
➜ xxd -s 0x120 -l 88 ConsoleApplication1.exe
00000120: 0000 0040 0100 0000 0010 0000 0002 0000  ...@............
00000130: 0600 0000 0000 0000 0600 0000 0000 0000  ................
00000140: 0070 0000 0004 0000 0000 0000 0300 6081  .p............`.
00000150: 0000 1000 0000 0000 0010 0000 0000 0000  ................
00000160: 0000 1000 0000 0000 0010 0000 0000 0000  ................
00000170: 0000 0000 1000 0000                      ........

### Third section, variable will leave it for now.
```
